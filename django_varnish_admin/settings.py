...
DATABASES = {
    'default': {
        ...
        'NAME': 'djvaradm.dbf',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = ( (os.path.join(os.path.dirname(__file__), '..', 'frontend/media', ).replace('\\','/')),
...
SECRET_KEY = '2_a&amp;18_9e8*awse1pt1z1btf(wyl$tfzdr$@8&amp;ced(!4m$e=zb'
